...
import com.depromeet.archive.infra.user.oauth.provider.AppleClient.AppleOAuthProperty;
import com.depromeet.archive.infra.user.oauth.provider.AppleClient.AppleTokenVerifier;
